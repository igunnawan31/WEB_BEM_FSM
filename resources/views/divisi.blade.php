...
<body>
            ...
            <div class="container mx-auto lg:px-8">
                <div class="w-full flex items-center justify-center lg:pl-8">
                    <div class="text-center lg:text-left">
                        ...
                        <h2 class="text-xl font-bold text-white md:text-2xl lg:text-3xl">Kantor Media Informasi</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- <div class="container mx-auto px-4">
        <h2 class="text-center text-white font-bold text-2xl mb-8">Program Kerja Biro Kantor Media Informasi</h2>
        <div class="swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="bg-gradient-to-r from-[#ED8720]-400 to-[#ED8720]-500 rounded-lg p-6 flex items-center justify-center h-64">
                        <p class="text-white font-bold text-xl">Riung Archive</p>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="bg-gradient-to-r from-[#ED8720]-400 to-[#ED8720]-500 rounded-lg p-6 flex items-center justify-center h-64">
