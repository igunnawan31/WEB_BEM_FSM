<footer class="py-8 text-white" style="background: linear-gradient(0deg, rgb(189, 100, 103) 0%, rgba(29, 102, 166, 1) 100%);" class="h-64">
    <div class="mx-auto container ">
                ...
                <ul>
                    <li class="flex items-center text-sm ">
                        ...
                        <span class="ml-2">
                            <a href="https://wa.me/6281326657545" class="text-white hover:text-white relative group">
                                WhatsApp
                                <span class="absolute inset-0 bg-white opacity-0 transition-opacity duration-300 group-hover:opacity-40 blur-lg"></span>
                            </a>
                        </span>
                    </li>
                    ...
                    <li class="flex items-center text-sm mb-2">
                        <span class="inline-block">
                            ...
                            <svg width="25px" height="25px"  viewBox="0 0 48.00 48.00" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#ffffff" stroke="#ffffff" stroke-width="2.304"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><defs><style>.b{fill:#fff;}.c{fill:none;stroke:#fff;stroke-linecap:round;stroke-linejoin:round;}</style></defs><circle class="b" cx="15.64" cy="13.46" r=".75"></circle><line class="c" x1="15.64" x2="15.64" y1="16.93" y2="31.91"></line><path class="c" d="m33.11 31.91v-9.61a5.83 5.83 0 0 0-5.82-5.82 5.83 5.83 0 0 0-5.83 5.82v9.61"></path><line class="c" x1="21.46" x2="21.46" y1="22.3" y2="16.93"></line><path class="c" d="m40.5 5.5h-33a2 2 0 0 0-2 2v33a2 2 0 0 0 2 2h33a2 2 0 0 0 2-2v-33a2 2 0 0 0-2-2z"></path></g></svg>
                        </span>
                        <span class="ml-2">
                            <a href="https://www.linkedin.com/company/bemfsmundip/" class="text-white hover:text-white relative group">
                                bemfsmundip
                                <span class="absolute inset-0 bg-white opacity-0 transition-opacity duration-300 group-hover:opacity-40 blur-lg"></span>
                            </a>
                        </span>
        ...
        <div class="w-full mt-4 pt-6 border-t border-slate-600 px-8">
            ...
            <div class="flex items-center justify-center mb-4 md:justify-between mx-12 md:gap-4">
                <p class="hidden font-medium text-xs text-center text-slate-400 md:text-sm md:block">Copyright © Muhammad Gunawan | Daffa Hirza Ni'am | Mohammad Izza Hakiki | Muhammad Dimas Arya Putra<p>
                <div class="flex">
                <!-- youtube -->
                    <a href="#" target="_blank" class="w-9 h-9  mr-3 rounded-full flex justify-center items-center border border-slate-300 text-white hover:border-blueRiung hover:bg-blueRiung ">
                    ...
                    <!-- twitter -->
                    <a href="#" target="_blank" class="w-9 h-9  mr-3 rounded-full flex justify-center items-center border border-slate-300 hover:border-blueRiung hover:bg-blueRiung  text-white">
            ...
            <p class="font-medium text-xs text-center text-slate-300 md:hidden md:text-sm">Copyright © Muhammad Gunawan | Daffa Hirza Ni'am | Mohammad Izza Hakiki | Muhammad Dimas Arya Putra </p>
        </div>
    </div>
</footer>