            ...
            <div class="container mx-auto px-4 ">
                <div class="flex flex-wrap px-5 md:px-0 lg:px-16">
                    ...
                    <div class="w-full mt-10 flex flex-col items-center justify-center gap-12 md:gap-8 md:px-4 lg:gap-12 md:flex-row">
                        ...
                        <!-- button -->
                        <a class="hidden text-xl bg-[#121026] rounded-full py-2 px-4 text-white hover:shadow-2xl hover:bg-orange transition duration-300 ease-in-out md:block md:text-sm lg:text-xl md:order-2 animate-on-scroll" href="#">Selengkapnya</a>
                        <!-- kabem -->
                        ...
                        <!-- button for mobile -->
                        <a class="order-last text-sm bg-[#121026] rounded-full py-3 px-8 text-white hover:shadow-2xl hover:bg-orange transition duration-300 ease-in-out md:hidden" href="#">Selengkapnya</a>
                    </div>
                </div>
            </div>
        </section>
